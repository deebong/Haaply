...
export const AnyaLifestyleSection: React.FC = () => {
  ...
  return (
    <section className="py-16 sm:py-24 bg-white border-b border-[#E7C8CF]/60">
      <div className="max-w-[1360px] mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 relative">
            <div className="relative rounded-3xl overflow-hidden aspect-4/3 sm:aspect-16/11 shadow-lg border-4 border-[#FFF4F6]">
              <img
            ...
            {/* Founder Note Card */}
            <div className="mt-6 p-6 rounded-2xl bg-[#FFF4F6] border border-[#E7C8CF] shadow-xs flex items-start gap-4">
              <img
          ...
          <div className="lg:col-span-6 flex flex-col items-start">
            ...
            >
              A Simple Ritual for{' '}
              <span className="italic font-normal text-[#8FA08C]">Healthier Skin</span>
            </h2>
            ...
            <div className="mt-6 space-y-3.5 w-full">
              {outcomes.map((item, idx) => (
                <div key={idx} className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-[#FDECEF] flex items-center justify-center text-[#8FA08C] shrink-0 mt-0.5">
            ...
            {/* Micro Badge */}
            <div className="mt-8 flex items-center gap-3 p-4 rounded-xl bg-[#FDECEF]/60 border border-[#E7C8CF] text-xs text-[#2F2326]">
              <Sparkles className="w-4 h-4 text-[#8FA08C] shrink-0" />
